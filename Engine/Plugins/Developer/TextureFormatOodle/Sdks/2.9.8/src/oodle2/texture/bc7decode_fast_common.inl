...
static RADFORCEINLINE void simd_decode_mode2_endpoints(Vec128_U8 * out_lo8, Vec128_U8 * out_hi8, const Vec128_U8 &block128, const U8 * block_bits)
{
	...
	*out_lo8 = lo16.s16().to_uint8_sat(ba16.s16());
	*out_hi8 = hi16.s16().to_uint8_sat(ba16.s32().zwxy().s16());
}
...
static RADFORCEINLINE Vec128_U16 simd_decode_mode6_endpoints(const Vec128_U8 &block128)
{
	...
	// Add in the p-bits.
	const Vec128_S32 mask_pbits = Vec128_S32(0,-2*(1<<30), 1,0);
	const Vec128_S16 mask_lsb = Vec128_S16(1);

	Vec128_S32 pbits_set = (block128.s32() & mask_pbits).cmp_eq64(mask_pbits);
	Vec128_S16 endpoints = endpoints_no_pbit | (pbits_set.s16() & mask_lsb);
...
static RADFORCEINLINE Vec128_U8 simd_decode_mode6_inds(const Vec128_U8 &block128)
{
	...
	Vec128_U8 index4_lo3 = block128 & Vec128_S32(0, 0, 7<<1, 0).u8();
	Vec128_U8 index4_rest = block128 & Vec128_S32(0, 0, -16, -1).u8();
#if defined(DO_BUILD_SSE4)
	Vec128_U8 index4_with_anchor = index4_rest | _mm_srli_epi64(index4_lo3, 1);
#else // defined(DO_BUILD_NEON64)
	Vec128_U8 index4_with_anchor = index4_rest | vshrq_n_u64(index4_lo3, 1);
#endif
