...
static inline void store256a(void *ptr, Vec256 x)	{ _mm256_store_si256((__m256i *)ptr, x); }
static inline void store256u(void *ptr, Vec256 x)	{ _mm256_storeu_si256((__m256i *)ptr, x); }

static inline Vec128 lo_half(Vec256 x)				{ return _mm256_castsi256_si128(x); }
static inline Vec128 hi_half(Vec256 x)				{ return _mm256_extracti128_si256(x, 1); }
static inline Vec256 combine(Vec128 a, Vec128 b)	{ return _mm256_setr_m128i(a, b); }
static inline Vec256 zext128_256(Vec128 x)			{ return _mm256_setr_m128i(x, _mm_setzero_si128()); }
static inline Vec256 broadcast128_256(Vec128 x)		{ return _mm256_broadcastsi128_si256(x); }
...
static inline Vec256 shuffle32in128(Vec256 v)		{ return _mm256_shuffle_epi32(v, _MM_SHUFFLE(w,z,y,x)); }

template<int x,int y,int z,int w>
static inline Vec256 shuffle64(Vec256 v)			{ return _mm256_permute4x64_epi64(v, _MM_SHUFFLE(w,z,y,x)); }

static inline Vec256 vec_packed_add(Vec256 a, Vec256 b, Vec256 mask_nonmsb)
{
...
static inline Vec256 zext8to16_lo_in128(Vec256 x)			{ return _mm256_unpacklo_epi8(x, _mm256_setzero_si256()); }
static inline Vec256 zext8to16_hi_in128(Vec256 x)			{ return _mm256_unpackhi_epi8(x, _mm256_setzero_si256()); }

static inline Vec256 blend32(Vec256 a, Vec256 b, Vec256 mask)	{ return _mm256_castps_si256(_mm256_blendv_ps(_mm256_castsi256_ps(a), _mm256_castsi256_ps(b), _mm256_castsi256_ps(mask))); }

static inline S32 reduce_add_s32(Vec256 x)				{ return reduce_add_s32(_mm_add_epi32(lo_half(x), hi_half(x))); }
static inline U32 reduce_add_u32(Vec256 x)				{ return reduce_add_u32(_mm_add_epi32(lo_half(x), hi_half(x))); }
...
#define RR_DECL_INT_COMMON(typ,suffixi) \
	...
	static typ loadu_lo128(const void * ptr)		{ return typ(_mm256_setr_m128i(_mm_loadu_si128((const __m128i *)ptr), _mm_setzero_si128())); } \
	static typ loadu_dup128(const void * ptr)		{ return typ(_mm256_broadcastsi128_si256(_mm_loadu_si128((const __m128i *)ptr))); } \
	static typ loadu_lo64(const void * ptr)			{ return typ(_mm256_setr_m128i(_mm_loadl_epi64((const __m128i *)ptr), _mm_setzero_si128())); } \
	static typ loadu_dup64(const void * ptr)		{ return typ(_mm256_broadcastq_epi64(_mm_loadl_epi64((const __m128i *)ptr))); } \
	static typ loadu_lo32(const void * ptr)			{ return typ(_mm256_setr_m128i(_mm_cvtsi32_si128(RR_GET32_NATIVE_UNALIGNED(ptr)), _mm_setzero_si128())); } \
...
#define RR_IMPL_INT_COMMON(typ) \
	...
	inline Vec256_U32 typ::u32() const				{ return Vec256_U32(v); } \
...
struct Vec256_S32
{
	...
	Vec256_S32 cmp_eq(Vec256_S32 b) const			{ return Vec256_S32(_mm256_cmpeq_epi32(v, b)); }
	Vec256_S32 cmp_gt(Vec256_S32 b) const			{ return Vec256_S32(_mm256_cmpgt_epi32(v, b)); }
	Vec256_S32 max(Vec256_S32 b) const				{ return Vec256_S32(_mm256_max_epi32(v, b)); }
	Vec256_S32 min(Vec256_S32 b) const				{ return Vec256_S32(_mm256_min_epi32(v, b)); }
	Vec256_S32 mullo(Vec256_S32 b) const 			{ return Vec256_S32(_mm256_mullo_epi32(v, b)); }
	...
	Vec256_S32 permute(Vec256_S32 b) const			{ return Vec256_S32(_mm256_permutevar8x32_epi32(v, b)); }
...
struct Vec256_U8
{
	...
	Vec256_U8 cmp_eq(Vec256_U8 b) const				{ return Vec256_U8(_mm256_cmpeq_epi8(v, b)); }
	Vec256_U8 cmp_gt(Vec256_U8 b) const				{ return Vec256_U8(_mm256_cmpgt_epi8(v, b)); }
	Vec256_U8 max(Vec256_U8 b) const				{ return Vec256_U8(_mm256_max_epu8(v, b)); }
	Vec256_U8 min(Vec256_U8 b) const				{ return Vec256_U8(_mm256_min_epu8(v, b)); }

	Vec256_U8 shuf_in128(Vec256 m) const			{ return Vec256_U8(_mm256_shuffle_epi8(v, m)); }
...
struct Vec256_U32
{
	...
	Vec256_U32() {}
	explicit Vec256_U32(Vec256 x) : v(x) {}
	explicit Vec256_U32(U32 x) : v(_mm256_set1_epi32((S32)x)) {}
	Vec256_U32(U32 e0, U32 e1, U32 e2, U32 e3, U32 e4, U32 e5, U32 e6, U32 e7)
		: v(_mm256_setr_epi32((S32)e0, (S32)e1, (S32)e2, (S32)e3, (S32)e4, (S32)e5, (S32)e6, (S32)e7)) {}

	RR_DECL_INT_COMMON(Vec256_U32,epi32)

	template<int index> U32 extract() const			{ return _mm256_extract_epi32(v, index); }
	template<int index> void insert(U32 x) 			{ v = _mm256_insert_epi32(v, x, index); }

	U32 movemask() const 							{ return _mm256_movemask_ps(_mm256_castsi256_ps(v)); }

	Vec256_U32 cmp_eq(Vec256_U32 b) const			{ return Vec256_U32(_mm256_cmpeq_epi32(v, b)); }
	Vec256_U32 max(Vec256_U32 b) const				{ return Vec256_U32(_mm256_max_epu32(v, b)); }
	Vec256_U32 min(Vec256_U32 b) const				{ return Vec256_U32(_mm256_min_epu32(v, b)); }
	Vec256_U32 mullo(Vec256_U32 b) const 			{ return Vec256_U32(_mm256_mullo_epi32(v, b)); }

	Vec256_U32 shl(Vec256_U32 count) const			{ return Vec256_U32(_mm256_sllv_epi32(v, count)); }
	Vec256_U32 sra(Vec256_U32 count) const			{ return Vec256_U32(_mm256_srav_epi32(v, count)); }
	Vec256_U32 srl(Vec256_U32 count) const			{ return Vec256_U32(_mm256_srlv_epi32(v, count)); }

	template<int count> Vec256_U32 shl() const		{ return Vec256_U32(_mm256_slli_epi32(v, count)); }
	template<int count> Vec256_U32 sra() const		{ return Vec256_U32(_mm256_srai_epi32(v, count)); }
	template<int count> Vec256_U32 srl() const		{ return Vec256_U32(_mm256_srli_epi32(v, count)); }

	//Vec256_S8 shuf_in128(Vec256r m) const			{ return Vec256_S8(_mm256_shuffle_epi8(v, m)); }
	Vec256_U32 operator *(Vec256_U32 b) const		{ return mullo(b); }
	Vec256_U32 &operator *=(Vec256_U32 b)			{ *this = mullo(b); return *this; }

	Vec256_U32 operator <<(Vec256_U32 b)			{ return shl(b); }
	Vec256_U32 &operator <<=(Vec256_U32 b)			{ v = shl(b); return *this; }
	Vec256_U32 operator >>(Vec256_U32 b)			{ return sra(b); }
	Vec256_U32 &operator >>=(Vec256_U32 b)			{ v = sra(b); return *this; }

	Vec256_U32 permute(Vec256_U32 b) const			{ return Vec256_U32(_mm256_permutevar8x32_epi32(v, b)); }

	template<int x,int y,int z,int w>
	Vec256_U32 shuffle_in128() const				{ return Vec256_U32(shuffle32in128<x,y,z,w>(v)); }

	// Sum of squared differences of 4 U8 values per 32-bit lane
	//   result[i] = (a[i*4] - b[i*4])^2, ..., (a[i*4+3] - b[i*4+3])^2
	static Vec256_U32 ssd4(Vec256_U8 a, Vec256_U8 b)
	{
		// Compute 8-bit absolute differences between a and b
		Vec256_U8 abs_diff = a.max(b) - a.min(b);

		// Turn even and odd 8b lanes into 16-bit values
		Vec256_S16 evn = abs_diff.s16() & Vec256_S16 { 0x00ff };
		Vec256_S16 odd = abs_diff.s16().srl<8>();

		// Sum of squares of pairs
		Vec256_S32 sum_evn = evn.madd(evn);
		Vec256_S32 sum_odd = odd.madd(odd);
...
struct Vec256_F32
{
	...
	static Vec256_F32 broadcast(VecF32x4 x)			{ return Vec256_F32(_mm256_setr_m128(x, x)); }
	static Vec256_F32 combinef(VecF32x4 a, VecF32x4 b) { return Vec256_F32(_mm256_setr_m128(a, b)); }
	...
	// conversions
	Vec256_S32 to_int32_round() const;
	Vec256_S32 to_int32_trunc() const;
...
RR_IMPL_INT_COMMON(Vec256_U32)

// Conversions
inline Vec256_S32 Vec256_F32::to_int32_round() const	{ return Vec256_S32(_mm256_cvtps_epi32(v)); }
inline Vec256_S32 Vec256_F32::to_int32_trunc() const	{ return Vec256_S32(_mm256_cvttps_epi32(v)); }
...
static inline S32 reduce_add(Vec256_S32 a)					{ return reduce_add_s32(a); }
static inline U32 reduce_add(Vec256_U32 a)					{ return reduce_add_u32(a); }
