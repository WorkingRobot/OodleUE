...
extern const BC7OptimalEndpoint bc7_optimal_endpoints[3*4 + 3*2 + 1*1 + 1*4 + 1*4][256]; // [table_id][color], table_id depends on mode, p_bits, index
extern const BC7OptimalEndpoint bc7_scalar_optimal_endpoints[3][256]; // [type][color] type 0=mode4/3b, 1=mode4/2b, 2=mode5
