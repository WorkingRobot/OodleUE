...
static RADFORCEINLINE void sse4_alpha_override_endpoints16(Vec128 * lo16, Vec128 * hi16, bool ignore_alpha)
{
	if ( ignore_alpha )
	{
		Vec128 override_alpha = _mm_setr_epi16(0,0,0,255, 0,0,0,255);
		*lo16 = _mm_or_si128(*lo16, override_alpha);
		*hi16 = _mm_or_si128(*hi16, override_alpha);
	}
}
