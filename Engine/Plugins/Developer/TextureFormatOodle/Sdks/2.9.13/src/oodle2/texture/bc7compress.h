...
struct BC7EncOptions
{
	...
	// Error threshold for 2-subset partitions to consider 3-subset ones. If the worst 2-subset
	// partition under consideration has an error smaller than this, don't even try 3-subset.
	F32 err_threshold_for_subset3 = 0.0f;
