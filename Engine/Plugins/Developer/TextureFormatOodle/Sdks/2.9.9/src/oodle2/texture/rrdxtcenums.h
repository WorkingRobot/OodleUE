...
enum rrDXTCOptions
{
	...
	rrDXTCOptions_BC3457_PreserveExtremes = 2, // BC3,4,5,7 respect this (alpha on 4c formats, otherwise all channels), BC1,2,6 it doesn't apply
	...
	// Avoid/Prefer wide vectors (AVX-512)
	rrDXTCOptions_AvoidWideVectors = 32,
	rrDXTCOptions_PreferWideVectors = 64,

	// Convert linear to sRGB for float input in BC1237
	rrDXTCOptions_LinearToSRGB = 128,
