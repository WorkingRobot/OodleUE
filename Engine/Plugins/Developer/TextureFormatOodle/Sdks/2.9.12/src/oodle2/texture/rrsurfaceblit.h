...
// Non-normalized version. Doesn't rescale pixel values on format change, e.g.
// U8 -> F32 blits gives floats in [0,255].
//
// Normalized version exists in rrsurfaceutil.h and is generally preferred.
...
void rrSurface_GetColor4I( const rrSurface * surf, rrColor4I * color, SINTa x, SINTa y);
void rrSurface_GetColor4F( const rrSurface * surf, rrColor4F * color, SINTa x, SINTa y);
