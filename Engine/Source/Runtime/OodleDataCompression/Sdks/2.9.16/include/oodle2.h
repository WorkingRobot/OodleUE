...
{
    // Circular window entirely unsupported as of 2.9.16, but entry points remains for API compat
    const OO_U32 set = 0;
...
/* Get the size you must malloc the decode (raw) buffer
    ...
    As of Oodle 2.9.0 this function is not required.  For all new codecs you can just use the size of the
