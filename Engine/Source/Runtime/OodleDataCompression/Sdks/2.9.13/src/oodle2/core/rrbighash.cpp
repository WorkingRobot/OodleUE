...
#define VEC_INIT(a,b,c,d) (uint32x4_t{(a),(b),(c),(d)})
...
#define VEC_INIT(a,b,c,d) t_u32quad(_mm_setr_epi32((a),(b),(c),(d)))
...
#define VEC_INIT(a,b,c,d) {{(a),(b),(c),(d)}}
	...
	t_u32quad & a,t_u32quad & b,t_u32quad & c,U32 length)
{
	...
	const t_u32quad c_init_a = VEC_INIT(0xdeadbeef, 0xdeadbeef, 0xdeadbeef, 0xdeadbeef);
	const t_u32quad c_init_b = VEC_INIT(0x206F85B3, 0x206F85B3, 0x206F85B3, 0x206F85B3);
	const t_u32quad c_init_c = VEC_INIT(0x5768B525, 0x5768B525, 0x5768B525, 0x5768B525);

	a = c_init_a;
	b = c_init_b;
	c = c_init_c;

	t_u32quad lens = VEC_INIT(length, length, length, length);
	a += lens;
	c -= lens;
}
