...
//idoc(parent,OodleAPI_OodleTexRT_Plugins)
#pragma once
...
IDOC OODEFFUNC typedef void * (OODLE_CALLBACK t_fp_OodleTexRT_Plugin_MallocAligned)( OO_SINTa bytes, OO_S32 alignment);
...
IDOC OODEFFUNC typedef void (OODLE_CALLBACK t_fp_OodleTexRT_Plugin_Free)( void * ptr );
...
IDOC OOFUNC1 void OOFUNC2 OodleTexRT_Plugins_SetAllocators(
...
IDOC OODEFFUNC typedef OO_U64 (OODLE_CALLBACK t_fp_OodleTexRT_Plugin_RunJob)( t_fp_Oodle_Job * fp_job, void * job_data , OO_U64 * dependencies, int num_dependencies, void * user_ptr );
...
IDOC OODEFFUNC typedef void (OODLE_CALLBACK t_fp_OodleTexRT_Plugin_WaitJob)( OO_U64 job_handle, void * user_ptr );
/* Function pointer type for OodleTexRT_Plugins_SetJobSystem
...
IDOC OOFUNC1 void OOFUNC2 OodleTexRT_Plugins_SetJobSystem(
...
IDOC OOFUNC1 void OOFUNC2 OodleTexRT_Plugins_SetJobSystemAndCount(
	t_fp_OodleTexRT_Plugin_RunJob * fp_RunJob,
	t_fp_OodleTexRT_Plugin_WaitJob * fp_WaitJob,
...
IDOC OODEFFUNC typedef void (OODLE_CALLBACK t_fp_OodleTexRT_Plugin_Printf)(int verboseLevel,const char * file,int line,const char * fmt,...);
...
IDOC OOFUNC1 t_fp_OodleTexRT_Plugin_Printf * OOFUNC2 OodleTexRT_Plugins_SetPrintf(t_fp_OodleTexRT_Plugin_Printf * fp_rrRawPrintf);
...
IDOC OODEFFUNC typedef OO_BOOL (OODLE_CALLBACK t_fp_OodleTexRT_Plugin_DisplayAssertion)(const char * file,const int line,const char * function,const char * message);
...
IDOC OOFUNC1 t_fp_OodleTexRT_Plugin_DisplayAssertion * OOFUNC2 OodleTexRT_Plugins_SetAssertion(t_fp_OodleTexRT_Plugin_DisplayAssertion * fp_rrDisplayAssertion);
...
extern t_fp_OodleTexRT_Plugin_MallocAligned * g_fp_OodleTexRT_Plugin_MallocAligned;
extern t_fp_OodleTexRT_Plugin_Free * g_fp_OodleTexRT_Plugin_Free;
extern t_fp_OodleTexRT_Plugin_DisplayAssertion * g_fp_OodleTexRT_Plugin_DisplayAssertion;
extern t_fp_OodleTexRT_Plugin_Printf *	g_fp_OodleTexRT_Plugin_Printf;
extern t_fp_OodleTexRT_Plugin_RunJob *	g_fp_OodleTexRT_Plugin_RunJob;
extern t_fp_OodleTexRT_Plugin_WaitJob *	g_fp_OodleTexRT_Plugin_WaitJob;

extern int OodleTexRT_Plugin_GetJobTargetParallelism();
