...
// OodleTex_Err is in texbase.h!

PUBTYPESTART

IDOC typedef enum OodleTex_PixelFormat
{
...
IDOC typedef OOSTRUCT OodleTex_Surface
{
...
#define OODLETEX_MAX_SURFACE_DIMENSION 2097152 IDOC
...
#define OODLETEX_MAX_SURFACE_COUNT 2097152 IDOC
/* Maximum number of OodleTex_Surfaces passed to a single Oodle Texture invocation.
...
IDOC typedef enum OodleTex_EncodeEffortLevel
{
...
IDOC typedef enum OodleTex_RDOLagrangeLambda
{
...
IDOC typedef enum OodleTex_BCNFlags
{
...
IDOC typedef enum OodleTex_BCNDecodeFlags
{
...
IDOC typedef enum OodleTex_RDO_ErrorMetric
{
...
IDOC typedef struct OodleTex_Layout OodleTex_Layout;
...
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_LogVersion();
...
IDOC OOFUNC1 const char * OOFUNC2 OodleTex_Err_GetName(OodleTex_Err error);
/* Provides a string naming a $OodleTex_Err enum
*/

IDOC OOFUNC1 const char * OOFUNC2 OodleTex_PixelFormat_GetName(OodleTex_PixelFormat pf);
/* Provides a string naming a OodleTex_PixelFormat enum
*/

IDOC OOFUNC1 const char * OOFUNC2 OodleTex_BC_GetName(OodleTex_BC bcn);
...
IDOC OOFUNC1 OO_S32 OOFUNC2 OodleTex_PixelFormat_BytesPerPixel(OodleTex_PixelFormat pf);
...
IDOC OOFUNC1 OodleTex_PixelFormat OOFUNC2 OodleTex_BC_GetNaturalDecodeFormat(OodleTex_BC bcn);
...
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_EncodeBCN_LinearSurfaces(
...
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_EncodeBCN_Blocks(
	OodleTex_BC to_bcn,void * to_bcn_blocks,OO_SINTa num_blocks,
...
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_EncodeBCN_RDO(
	OodleTex_BC to_bcn,void * to_bcn_blocks,OO_SINTa num_blocks,
	const OodleTex_Surface * from_surfaces,OO_SINTa num_from_surfaces,OodleTex_PixelFormat from_format,
	const OodleTex_Layout * layout,
...
*/
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_DecodeBCN_Blocks_Ex(
	void* to_pixel_blocks, OodleTex_PixelFormat to_format, OO_SINTa num_blocks,
...
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_DecodeBCN_LinearSurfaces(
...
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_DecodeBCN_LinearSurfaces_Ex(
	OodleTex_Surface* to_surfaces, OO_SINTa num_to_surfaces, OodleTex_PixelFormat to_format,
	OodleTex_BC from_bcn, const void* from_bcn_blocks, OO_SINTa num_blocks,
...
IDOC OOFUNC1 OO_SINTa OOFUNC2 OodleTex_BC7Prep_MinEncodeOutputSize(OO_SINTa nblocks);
...
IDOC OOFUNC1 OO_SINTa OOFUNC2 OodleTex_BC7Prep_MinEncodeScratchSize(OO_SINTa nblocks);
/* Returns the amount of scratch buffer space required (in bytes) for the
   given number of BC7 blocks when encoding, or an $OodleTex_Err on error.
*/

IDOC OOFUNC1 OO_SINTa OOFUNC2 OodleTex_BC7Prep_Encode(OodleTexRT_BC7PrepHeader * out_header,
...
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_Layout_Create(
...
IDOC OOFUNC1 void OOFUNC2 OodleTex_Layout_Destroy(OodleTex_Layout * layout);
/* Destroys a given OodleTex_Layout object and frees all associated memory.
*/

IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_Layout_GenerateBlockIDs(
	const OodleTex_Layout * layout,
	int surface_index,
...
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_Layout_SetBlockLayout(
...
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_Layout_CopyBCNToLinear(
	OodleTex_BC bcn,
...
IDOC OOFUNC1 OO_F32 OOFUNC2 OodleTex_RMSE_Normalized_BCNAware(
	OodleTex_BC was_bcn,
...
IDOC OOFUNC1 OodleTex_Err OOFUNC2 OodleTex_BlitNormalized(
...
IDOC OODEFFUNC typedef OO_BOOL (OODLE_CALLBACK t_fp_OodleTex_Plugin_CancelRequested)(void * user_ptr);
...
IDOC OOFUNC1 void OOFUNC2 OodleTex_Plugins_SetCancelRequested(t_fp_OodleTex_Plugin_CancelRequested * fp_CancelRequested);
...
extern t_fp_OodleTex_Plugin_CancelRequested * g_fp_CancelRequested;
