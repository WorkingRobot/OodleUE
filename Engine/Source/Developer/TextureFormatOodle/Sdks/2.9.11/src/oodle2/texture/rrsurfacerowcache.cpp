...
rrbool rrSurfaceRowCache::Start(rrSurface * surf,rrPixelFormat format,SINTa numRows,ERRSurfaceRowCacheAction action,SINTa alignment_padding)
{	
	m_paddingX = 0;
	m_paddingY = 0;
...
rrbool rrSurfaceRowCache::StartReadC(const rrSurface * surf,rrPixelFormat format,SINTa numRows,SINTa alignment_padding)
{
